...
export default function Integrations() {
  ...
  const fetchAudiences = useCallback(async () => {
    try {
      ...
      // 1. Fetch local manual audiences from audience_requests
      try {
      ...
      // 2. Fetch from external Traffic AI API (may fail if no API key)
      try {
        ...
        <div className="col-lg-4">
          ...
          <div className="card bg-azure-lt">
            <div className="card-body text-center py-4">
              <IconPlug size={32} className="text-azure mb-2" />
              <h4 className="mb-1">More integrations coming soon</h4>
              <p className="text-muted small mb-0">
                HubSpot, Mailchimp, ActiveCampaign, and more
              </p>
            </div>
          </div>
        </div>
