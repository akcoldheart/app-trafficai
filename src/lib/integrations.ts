...
export type PlatformType = 'hubspot' | 'slack' | 'zapier' | 'salesforce' | 'shopify' | 'mailchimp' | 'pipedrive' | 'activecampaign' | 'facebook' | 'linkedin' | 'ringcentral' | 'google_ads' | 'zerobounce';
