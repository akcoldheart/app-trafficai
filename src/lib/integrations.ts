...
export type PlatformType = 'klaviyo' | 'hubspot' | 'slack' | 'zapier' | 'salesforce' | 'shopify' | 'mailchimp' | 'pipedrive' | 'activecampaign' | 'facebook' | 'linkedin' | 'ringcentral' | 'google_ads' | 'google_sheets' | 'zerobounce';
