...
export const INTEGRATION_CONFIGS: Record<string, IntegrationConfig> = {
  ...
  linkedin: {
    ...
    setupSteps: [
      'Enter your LinkedIn email below to link your account',
      'Create a campaign and select contacts with LinkedIn URLs',
      'Generate an extension token from the LinkedIn integration page',
      'Install the Traffic AI Chrome extension and paste your token',
      'The extension sends connection requests from your real browser session',
    ],
    category: 'outreach',
  },
  ringcentral: {
  ...
  google_sheets: {
    ...
    setupSteps: [
      ...
      'Go to APIs & Services > OAuth consent screen, select "External", fill in app name and your email, then save',
      'Under "Test users", add the Google email(s) that will use this integration',
      'Go to APIs & Services > Credentials and click "Create Credentials" > "OAuth client ID"',
      'Select "Web application" as the application type',
      'Under "Authorized redirect URIs", add: https://app.trafficai.io/api/integrations/google_sheets/callback',
      'Copy the Client ID and Client Secret from the created credentials',
      'Paste both values below and click Connect — you will be redirected to Google to authorize access',
    ],
    category: 'automation',
  },
};
